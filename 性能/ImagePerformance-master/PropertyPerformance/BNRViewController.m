...
@interface BNRViewController ()<UIPickerViewDataSource,UIPickerViewDelegate>
...
//    self.loopStylePicker.delegate = self;
//    self.loopStylePicker.dataSource = self;
...
#ifdef TEST_IMAGE
    [self.loopSizeSlider setMinimumValue:1];
    [self.loopSizeSlider setMaximumValue:3000];
#endif
}
