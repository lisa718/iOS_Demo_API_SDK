    ...
    for (NSInteger n = 0; n < 3; n++) {
        dispatch_async(myQueue, ^{
            ...
            for (NSInteger i = 0; i < 500000000; i++) {
                ...
                if (i == 499999999) {
                    NSLog(@"串行异步任务%ld -> 完成%@",(long)n,[NSThread currentThread]);
                }
            }
        });
    }
    ...
    for (NSInteger n = 0; n < 3; n++) {
        dispatch_sync(myQueue, ^{
            ...
            for (NSInteger i = 0; i < 500000000; i++) {
                ...
                if (i == 499999999) {
                    NSLog(@"串行同步任务%ld -> 完成%@",(long)n,[NSThread currentThread]);
                }
            }
        });
    }
    ...
    for (NSInteger n = 0; n < 3; n++) {
        dispatch_async(myQueue, ^{
            ...
            for (NSInteger i = 0; i < 500000000; i++) {
                ...
                if (i == 499999999) {
                    NSLog(@"并行异步任务%ld -> 完成%@",(long)n,[NSThread currentThread]);
                }
            }
        });
    }
    ...
    for (NSInteger n = 0; n < 3; n++) {
        dispatch_sync(myQueue, ^{
            ...
            for (NSInteger i = 0; i < 500000000; i++) {
                ...
                if (i == 499999999) {
                    NSLog(@"并行同步任务%ld -> 完成%@",(long)n,[NSThread currentThread]);
                }
            }
        });
    }
...
- (IBAction)queueGroup:(id)sender {
    ...
    dispatch_group_async(group, globalQueue, ^{
        for (NSInteger i = 0; i < 3; i++) {
            NSLog(@"全局并行队列%ld %@",(long)i,[NSThread currentThread]);
        }
    });
    //队列组执行自定义并行队列
    dispatch_group_async(group, myQueue, ^{
        for (NSInteger i = 0; i < 4; i++) {
            NSLog(@"自定义并行队列%ld%@",(long)i,[NSThread currentThread]);
        }
    });
    //队列组执行主队列
    dispatch_group_async(group, mainQueue, ^{
        for (NSInteger i = 0; i < 5; i++) {
            NSLog(@"主队列%ld %@",(long)i,[NSThread currentThread]);
        }
    });
